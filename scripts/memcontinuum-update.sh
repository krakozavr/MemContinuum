...
#   is the memcontinuum skill's repair path -- run `/memcontinuum` to finish
#   it, not this command's. A `wired` row is never a licence to wire
#   anything. It is reported and left alone, and it does not make this
#   command fail.
